...
<div class="container-fluid">
					    ...
					    <tr>				
								<td id="portcounters">												
								    <?php 
									      ...
									      {
										    echo anchor("switches/portstatus/".$hardwaremodel.'/'.$port['name'].'/'.$objectid.'/'.$dnsName.'/'.$FQDN,$port['name']);
									      }	
									      else 
									      {
									      	echo ($port['name']);
								...
								<td id="portvlan">&nbsp;
								      <?php 						
									     If (!in_array($port['name'],$portsToLock) and $connectable) 
									    {
										  echo anchor("switches/showportvlan/".$hardwaremodel.'/'.$port['name'].'/'.$objectid.'/'.$dnsName.'/'.$FQDN,'<img src="'.base_url('assets/img/yellowrouter.png').'" class="objectdetails">'); 
									    }						      
								      ?>
								 </td>	
								...
								<td id="poe">&nbsp;
								      <?php 						
									     If (!in_array($port['name'],$portsToLock) and $connectable ) 
									    {
										  echo anchor("switches/showPoeStatus/".$hardwaremodel.'/'.$port['name'].'/'.$objectid.'/'.$dnsName.'/'.$FQDN,'<img src="'.base_url('assets/img/poetrans.png').'" class="objectdetails">'); 
									    }						      
								      ?>
								 </td>			
								<td id="macauth">&nbsp;
								      <?php 						
									     If (!in_array($port['name'],$portsToLock) and $connectable ) 
									    {
										  echo anchor("switches/showMacAuthStatus/".$hardwaremodel.'/'.$port['name'].'/'.$objectid.'/'.$dnsName.'/'.$FQDN,'<img src="'.base_url('assets/img/macauth_key.png').'" class="objectdetails">'); 
									    }						      
								      ?>
								 </td>										 					 
    ...
    $(document).ready(function(){
	   ...
	   $('.saveConfig').click(function() {
			...
			$('#progress-indicator').html("<br/><img src='" + BASEPATH + "assets/img/progressbar.gif' /> saving...</img>");
